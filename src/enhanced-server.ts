...
import { variantRoutes as originalRoutes } from './routes';
...
// Routes
app.use('/api/v1', originalRoutes); // Original API routes
app.use('/api/v2', enhancedRoutes);  // Enhanced API routes with database

// Backward compatibility route (for existing Postman collections)
app.use('/api/variants', originalRoutes); // Compatibility route for /api/variants/upload
